...
const PiePagina = () => {
    ...
    const pie_de_pagina: any = useTranslation(namespaces.pages.pie_de_pagina).t;
    ...
    return (
            ...
            <footer className="text-gray-600 body-font bg-gray-200">
                <div className="container px-5 py-8 mx-auto flex items-center sm:flex-row flex-col">
                    <a className="flex title-font font-medium items-center md:justify-start justify-center text-gray-900">
                        <span className="ml-3 text-xl">{common("title")}</span>
                    </a>
      ...
      <a className="ml-3 text-gray-500 hover:text-fuchsia-800">
